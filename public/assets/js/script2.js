 ...
 // const ch3Rating = prediction[2].probability.toFixed(2);
  ...
  if (cwbl000Rating == 1) {
   ...
   block.innerHTML = "RESULTS: <br>LIVESTOCK ID: CH0001 <br>HEALTH STATUS: GOOD <br> AGE: 2 years <br> WEIGHT: 2.7kg <br> SEX: MALE"
      ...
      block.innerHTML = "RESULTS; <br> LIVESTOCK ID: CW0001 <br> HEALTH STATUS: FAIR <br> AGE: 5 years <br> WEIGHT: 80kg <br> SEX: MALE"

  } else if (chw005Rating == 1) {

      block.innerHTML = "RESULTS; <br> LIVESTOCK ID: CW0002 <br> HEALTH STATUS: FAIR <br> AGE: 2 years and a month <br> WEIGHT: 75kg <br> SEX: FEMALE"

  } else if (gtbr006Rating == 1) {

      block.innerHTML = "RESULTS; <br> LIVESTOCK ID: CW0003 <br> HEALTH STATUS: FAIR <br> AGE: 3 years and 4 months <br> WEIGHT: 68kg <br> SEX: FEMALE"

  } else if (gtwh007Rating == 1) {

      block.innerHTML = "RESULTS; <br> LIVESTOCK ID: CW0004 <br> HEALTH STATUS: GOOD <br> AGE: 4 years <br> WEIGHT: 80kg <br> SEX: FEMALE"

  } else if (shyoung008Rating == 1) {

      block.innerHTML = "RESULTS; <br> LIVESTOCK ID: GT0001 <br> HEALTH STATUS: GOOD <br> AGE: 5 years <br> WEIGHT: 50kg <br> SEX: MALE"

  } else if (sholder009Rating == 1) {

      block.innerHTML = "RESULTS; <br> LIVESTOCK ID: GT0002 <br> HEALTH STATUS: GOOD <br> AGE: 3 years and 2 months <br> WEIGHT: 40kg <br> SEX: FEMALE"

   } 
   
   else if (pig010Rating == 1) {

      block.innerHTML = "RESULTS; <br> LIVESTOCK ID: GT0003 <br> HEALTH STATUS: GOOD <br> AGE: 1year and 8 months <br> WEIGHT: 50kg <br> SEX: MALE"
